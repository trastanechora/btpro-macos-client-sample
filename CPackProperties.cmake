...
string(REPLACE "#CPACK_PACKAGE_VERSION#" "1.11.2" CPACK_PACKAGE_FILE_NAME "${CPACK_PACKAGE_FILE_NAME}")
...
if (CPACK_BUNDLE_PLIST_SOURCE)
    ...
    string(REPLACE "#CPACK_PACKAGE_VERSION#" "1.11.2" INFO_PLIST_CONTENT "${INFO_PLIST_CONTENT}")
