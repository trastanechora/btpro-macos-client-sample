...
public:
	...
	enum WindowClass {
		...
		WC_TOOLTIPS_EXTRA                            = ::WC_TOOLTIPS_EXTRA,
		...
		WC_CC_TOKENLOGIN                             = ::WC_CC_TOKENLOGIN,
		WC_WATCH_COMPANY1                            = ::WC_WATCH_COMPANY1,
	...
	/* automatically generated from ../../widgets/cargo_table_widget.h */
	/** Widgets of the #CargosWindow class. */
	enum CargosWidgets {
		WID_CT_BACKGROUND                            = ::WID_CT_BACKGROUND,                            ///< Caption of the window.
		WID_CT_CAPTION                               = ::WID_CT_CAPTION,
		WID_CT_HEADER_CARGO                          = ::WID_CT_HEADER_CARGO,
		WID_CT_HEADER_AMOUNT                         = ::WID_CT_HEADER_AMOUNT,
		WID_CT_HEADER_INCOME                         = ::WID_CT_HEADER_INCOME,
		WID_CT_LIST                                  = ::WID_CT_LIST,
		WID_CT_AMOUNT                                = ::WID_CT_AMOUNT,
		WID_CT_INCOME                                = ::WID_CT_INCOME,
	};
	...
	enum IndustryDirectoryWidgets {
		...
		WID_ID_DROPDOWN_FILTER_TRANSPORTED           = ::WID_ID_DROPDOWN_FILTER_TRANSPORTED,           ///< Dropdown for filtering on industry is transported or not
		WID_ID_DROPDOWN_FILTER_INDUSTRY_TYPE         = ::WID_ID_DROPDOWN_FILTER_INDUSTRY_TYPE,         ///< Dropdown for filtering on industry type
	...
	enum SelectGameIntroWidgets {
		...
		WID_SGI_CC_HEADER                            = ::WID_SGI_CC_HEADER,

		WID_SGI_SERVERS_FORUM                        = ::WID_SGI_SERVERS_FORUM,
		WID_SGI_WEBSITE                              = ::WID_SGI_WEBSITE,
		WID_SGI_IRC_CHAT                             = ::WID_SGI_IRC_CHAT,
		WID_SGI_IRC_SERVERS_CHAT                     = ::WID_SGI_IRC_SERVERS_CHAT,
		WID_SGI_SERVER_RULES                         = ::WID_SGI_SERVER_RULES,
		WID_SGI_SERVER_WIKI                          = ::WID_SGI_SERVER_WIKI,
		WID_SGI_SERVER_VIP                           = ::WID_SGI_SERVER_VIP,

		WID_SGI_CC_USER                              = ::WID_SGI_CC_USER,
		WID_SGI_CC_USER_ENTER                        = ::WID_SGI_CC_USER_ENTER,
		WID_SGI_CC_PASSWORD                          = ::WID_SGI_CC_PASSWORD,
		WID_SGI_CC_SELECT_NICE                       = ::WID_SGI_CC_SELECT_NICE,
		WID_SGI_CC_SELECT_BTPRO                      = ::WID_SGI_CC_SELECT_BTPRO,
		WID_SGI_CC_SERVERS                           = ::WID_SGI_CC_SERVERS,

		WID_SGI_SERVERS                              = ::WID_SGI_SERVERS,
		WID_SGI_CC1                                  = ::WID_SGI_CC1,
		WID_SGI_CC2                                  = ::WID_SGI_CC2,
		WID_SGI_CC3                                  = ::WID_SGI_CC3,
		WID_SGI_CC4                                  = ::WID_SGI_CC4,
		WID_SGI_CC5                                  = ::WID_SGI_CC5,
		WID_SGI_CC6                                  = ::WID_SGI_CC6,
		WID_SGI_CC7                                  = ::WID_SGI_CC7,
		WID_SGI_CC8                                  = ::WID_SGI_CC8,
		WID_SGI_CC9                                  = ::WID_SGI_CC9,
		WID_SGI_CC10                                 = ::WID_SGI_CC10,
		WID_SGI_CC11                                 = ::WID_SGI_CC11,
		WID_SGI_CC12                                 = ::WID_SGI_CC12,
		WID_SGI_CC13                                 = ::WID_SGI_CC13,
		WID_SGI_CC14                                 = ::WID_SGI_CC14,
		WID_SGI_CC15                                 = ::WID_SGI_CC15,
		WID_SGI_CC16                                 = ::WID_SGI_CC16,
		WID_SGI_CC17                                 = ::WID_SGI_CC17,
		WID_SGI_CC18                                 = ::WID_SGI_CC18,
		WID_SGI_CC19                                 = ::WID_SGI_CC19,
		WID_SGI_CC20                                 = ::WID_SGI_CC20,
		WID_SGI_CC21                                 = ::WID_SGI_CC21,
		WID_SGI_CC22                                 = ::WID_SGI_CC22,
		WID_SGI_CC23                                 = ::WID_SGI_CC23,
		WID_SGI_CC24                                 = ::WID_SGI_CC24,
		WID_SGI_CC25                                 = ::WID_SGI_CC25,
	};
	...
	enum NetworkGameWidgets {
		...
		WID_NG_CC_NICE                               = ::WID_NG_CC_NICE,                               ///< n-ice filter
		WID_NG_CC_BTPRO                              = ::WID_NG_CC_BTPRO,                              ///< btpro filter
		WID_NG_CC_REDDIT                             = ::WID_NG_CC_REDDIT,                             ///< reddit filter
		WID_NG_CC_CITYMANIA                          = ::WID_NG_CC_CITYMANIA,                          ///< citymania filter
	};
	...
	enum BuildRailDepotWidgets {
		...
		WID_BRAD_DEPOT_AUTO                          = ::WID_BRAD_DEPOT_AUTO,                          ///< Build a depot, autoselect entrance.
	};
	...
	enum BuildRoadDepotWidgets {
		...
		WID_BROD_DEPOT_AUTO                          = ::WID_BROD_DEPOT_AUTO,                          ///< Depot, autodetect entry.
	};
	...
	enum BuildRoadStationWidgets {
		...
		WID_BROS_STATION_AUTO                        = ::WID_BROS_STATION_AUTO,                        ///< Terminal station, autoselect entry.
		WID_BROS_STATION_XY_AUTO                     = ::WID_BROS_STATION_XY_AUTO,                     ///< Drive-through station, autoselect direction.
	...
	enum StatusbarWidgets {
		...
		WID_S_RULES                                  = ::WID_S_RULES,
		WID_S_USER                                   = ::WID_S_USER,
	};
	...
	enum ToolbarNormalWidgets {
		...
		WID_TN_CARGOS                                = ::WID_TN_CARGOS,                                ///< Transported cargo menu
	...
	enum TownDirectoryWidgets {
		...
		TDW_CAPTION_TEXT                             = ::TDW_CAPTION_TEXT,
	};
	...
	enum CBTownWidgets {
		WID_CB_LOCATION                              = ::WID_CB_LOCATION,
		WID_CB_ADVERT                                = ::WID_CB_ADVERT,
		WID_CB_ADVERT_REGULAR                        = ::WID_CB_ADVERT_REGULAR,
		WID_CB_FUND                                  = ::WID_CB_FUND,
		WID_CB_FUND_REGULAR                          = ::WID_CB_FUND_REGULAR,
		WID_CB_POWERFUND                             = ::WID_CB_POWERFUND,
		WID_CB_DETAILS                               = ::WID_CB_DETAILS,
		WID_CB_CARGO_NAME                            = ::WID_CB_CARGO_NAME,
		WID_CB_CARGO_AMOUNT                          = ::WID_CB_CARGO_AMOUNT,
		WID_CB_CARGO_REQ                             = ::WID_CB_CARGO_REQ,
		WID_CB_CARGO_PREVIOUS                        = ::WID_CB_CARGO_PREVIOUS,
		WID_CB_CARGO_STORE                           = ::WID_CB_CARGO_STORE,
		WID_CB_CARGO_STORE_PCT                       = ::WID_CB_CARGO_STORE_PCT,
		WID_CB_CARGO_FROM                            = ::WID_CB_CARGO_FROM,
		WID_CB_CENTER_VIEW                           = ::WID_CB_CENTER_VIEW,
		WID_CB_TOWN_VIEW                             = ::WID_CB_TOWN_VIEW,
		WID_CB_SHOW_AUTHORITY                        = ::WID_CB_SHOW_AUTHORITY,
	};
